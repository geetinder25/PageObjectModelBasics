...
public class TestConfig{
	...
	public static String from = "dhillon.geetu@gmail.com";
	public static String password = "******";
	public static String[] to ={"geetudhillon@yahoo.com"};
	...
	public static String mysqldriver="com.mysql.cj.jdbc.Driver";  //com.mysql.jdbc.Driver
	public static String mysqluserName = "root";
	public static String mysqlpassword = "2925";
